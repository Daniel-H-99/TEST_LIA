...
from evaluation import EvaPipeline
...
class THPipeline():
    ...
    def initialize(self):
        ...
        ################################
        self.model = EvaPipeline(self.config.config.common.checkpoints.model.config)
        self.landmark_model = LandmarkModel(self.config.config.common.checkpoints.landmark_model.dir)
    ...
    def inference(self, src_name, drv_name, output_dir, save_frames=True):
        ...
        self.model.inference(args_run, save_frames=save_frames)
